...
GALLERIES: dict[str, list[dict[str, str]]] = {
    'print-orchestrator': [
        {'src': 'assets/screenshots/print-orchestrator-dashboard.png', 'alt': 'Print Orchestrator fleet dashboard', 'title': 'Fleet dashboard', 'copy': 'The live interface keeps printer, camera, power, job, and detection states visible together.', 'kind': 'screenshot', 'orientation': 'portrait'},
    ...
    'pfc-supervisor': [
        {'src': 'assets/screenshots/pfc-power-management-top.png', 'alt': 'PFC power management command center', 'title': 'Power command center', 'copy': 'Workload state, suspend controls, and the current savings snapshot are shown in one place.', 'kind': 'screenshot', 'orientation': 'portrait'},
        {'src': 'assets/screenshots/pfc-energy-ledger.png', 'alt': 'PFC energy ledger and savings charts', 'title': 'Energy ledger', 'copy': 'Observed sleep and estimated avoided energy remain separate so the savings claim is inspectable.', 'kind': 'screenshot', 'orientation': 'portrait'},
        {'src': 'assets/screenshots/pfc-ai-runtime.png', 'alt': 'PFC AI runtime reconciliation panel', 'title': 'Runtime recovery', 'copy': 'Endpoints are checked again after wake, including model identity and required GPU offload.', 'kind': 'screenshot', 'orientation': 'portrait'},
        {'src': 'assets/screenshots/pfc-eligibility-matrix.png', 'alt': 'PFC subsystem eligibility matrix', 'title': 'Suspend safety matrix', 'copy': 'Each rule reports eligible, blocked, unknown, or stale instead of hiding the decision.', 'kind': 'screenshot', 'orientation': 'portrait'},
    ],
    'ai-server': [
